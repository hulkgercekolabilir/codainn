...
module.exports = {
    ...
    execute(message, args, client, Embed) {
        ...
        let verifLevels = [
            "Yok",
            "Düşük hesapta e-posta doğrulanmış olmalıdır",
            "Orta - Discord'a 5 dakikadan daha uzun süre kayıtlı olmalıdır",
            "Yüksek - (╯ ° □ °） ╯︵ ┻━┻ - sunucunun üyesi 10 dakikadan uzun olmalıdır",
            "Çok Yüksek - ┻━┻ ミ ヽ (ಠ 益 ಠ) ﾉ 彡 ┻━┻ - doğrulanmış bir telefon numarasına sahip olmalıdır",
        ];
        ...
        const oggw = message.channel
            .send(Embed("",`Sunucu Bilgileri Araştırılıyor`,"info"))
            .then((message) => {
                setTimeout(() => {
                    let sunucu = new Discord.MessageEmbed()
                        .setAuthor(
                            ` ${guild.name} Sunucusunun Bilgileri`,
